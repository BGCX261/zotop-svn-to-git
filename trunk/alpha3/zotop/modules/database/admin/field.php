...
class field_controller extends controller
{
	...
	public function onPrimaryKey($tablename , $fieldname)
	{
	...
	public function onCreate($tablename, $position = 0)
	{
		...
		$header['title'] = '<a href="'.zotop::url('zotop/database').'">数据库管理</a> <i>></i> <a href="'.zotop::url('database/field/default',array('table'=>$tablename)).'">数据表 [ '.$tablename. ' ] </a>  <i>></i> 字段修改' ;
