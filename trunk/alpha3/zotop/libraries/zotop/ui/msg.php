...
class zotop_msg
{
    ...
    public static function error($title, $content='', $life=9 , $extra='')
    {
        ...
        $msg['content'] = empty($content) ? $title : $content;
		$msg['extra'] = $extra.'<div class="msg-title"><b>如果问题未能解决，请尝试以下操作：</b></div><ul class="list"><li>点击<a href="javascript:location.reload();"> 刷新 </a>重试，或者以后再试</li><li>或者尝试点击<a href="javascript:history.go(-1);"> 返回前页 </a>后再试</li></ul>';
        $msg['life'] = $life;
        msg::show($msg);
    }
