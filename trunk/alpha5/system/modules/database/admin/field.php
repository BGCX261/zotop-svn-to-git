...
class field_controller extends controller
{
    ...
    public function indexAction($tablename)
    {
        $db = zotop::db();
	...
	public function editAction($tablename,$fieldname)
	{
	...
	public function deleteAction($tablename, $fieldname)
	{
	...
	public function primaryKeyAction($tablename , $fieldname)
	{
	...
	public function addIndexAction($tablename , $fieldname)
	{
	...
	public function dropIndexAction($tablename , $indexname)
	{
		$indexes = zotop::db()->table($tablename)->index();
	...
	public function UniqueAction($tablename , $fieldname)
	{
		$indexes = zotop::db()->table($tablename)->index();
		if(isset($indexes[$fieldname]))
		{
	...
	public function FulltextAction($tablename , $fieldname)
	{
		$indexes = zotop::db()->table($tablename)->index();
		if(isset($indexes[$fieldname]))
		{
