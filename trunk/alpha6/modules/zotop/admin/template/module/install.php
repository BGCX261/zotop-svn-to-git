...
<div style="padding:15px;" class="clearfix">
	<div style="float:left;width:100px;text-align:center;padding-top:20px;"><?php echo html::image(empty($module['icon']) ? '$theme/image/skin/none.png' : $module['icon'], array('width'=>'48px'));?></div>
