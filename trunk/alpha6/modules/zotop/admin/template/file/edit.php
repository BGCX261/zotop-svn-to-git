...
<div class="" style="width:100%;height:460px;overflow:hidden;">
	...
	<script type="text/javascript">
		//显示按钮
		dialog.setTitle('编辑：<?php echo $file;?>').setWidth(800).setTip('小提示：快捷键 Ctrl+S 可以快速保存').setButtons([{text:'保 存',callback:save},{text:'保存并关闭',callback:ok},{text:'关 闭'}]);
		//加载编辑器
