...
class blog_controller_index extends controller
{
	...
	{
		return array(
			'index' => array('id'=>'index','title'=>'日志列表','href'=>zotop::url('blog/index/index',array('categoryid'=>$categoryid))),
			'add' => array('id'=>'add','title'=>'发表新日志','href'=>zotop::url('blog/index/add',array('categoryid'=>$categoryid))),
