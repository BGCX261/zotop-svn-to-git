...
class MsgController extends controller
{
   public function onDefault($status = -1)
   {
        ...
        page::header($header);
		   page::top();
		   page::navbar(array(
				array('id'=>'main','title'=>'短消息列表','href'=>url::build('system/msg')),
				array('id'=>'send','title'=>'发送短消息','href'=>url::build('system/msg/send'),'class'=>'dialog {width:600}'),
		   ),'main');
   ...
   public function onSend()
   {
        ...
        dialog::header($header);
			   ...
			   form::header(array('title'=>'','description'=>'请输入收信人的账户并输入短消息内容','class'=>'ajax'));
